...
html_theme_options = {
    ...
    'repo_name': 'instagram-archiver',
    'repo_url': 'https://github.com/Tatsh/instagram-archiver',
    'site_url': 'https://instagram-archiver.readthedocs.org',
...
intersphinx_mapping = {
    ...
    'yt-dlp-utils': ('https://yt-dlp-utils.readthedocs.io/en/latest/', None)
}
