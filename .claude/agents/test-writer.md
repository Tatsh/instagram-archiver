...
You write comprehensive pytest test suites for instagram-archiver. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('instagram_archiver.commands.module.some_function')
